...
const CHANNEL_AVATAR_URL =
  "https://yt3.googleusercontent.com/s9aYVXGdig6zHjfjsnxDlri33pDDoXDDs-9sh0TPclXs8z2PgeRZ1ukKCaCYiL6zlFBErQ6yi7w=s900-c-k-c0x00ffffff-no-rj";
...
const FALLBACK_ALL_VIDEOS: Partial<YouTubeFeedItem>[] = [
  {
    ...
    description:
      "Kigingi avuga ku rugendo rwiwe n'ivyabaye mu giteramo ciwe i Bujumbura. ELIMI MEDIA exclusive interview.",
    duration: "8:45",
    views: "178 views",
    uploadedAt: "Recently",
    likes: 5,
  ...
  },
  {
    ...
    title:
      "GUTAHUKANA IMODOKA MURI NDAGAHENDE NTIBIBA VYOROSHE/ NKUNDA JOSHUA JOSHUA KUKO NIWE YATUMYE...",
    description:
      "Ikiganiro kirambuye ku rugendo rwa Nkunda Joshua n'imodoka i Bujumbura.",
    duration: "12:30",
    views: "53 views",
    uploadedAt: "Recently",
    likes: 3,
  ...
  },
  {
    ...
    description:
      "ELIMI MEDIA: Coverage ya Inkerebutsi Day hamwe na Sebarundi n'umutambukanyi wiwe.",
    duration: "3:13",
    views: "417 views",
  ...
  },
  {
    ...
    description:
      "POLICE ELIMI: Filime yerekana ibikorwa bya Polisi no gukumira ibyaha mu mujyi wa Bujumbura.",
    duration: "38:35",
    views: "79 views",
  ...
  },
  {
    ...
    title:
      "Cadeau Lavelle ntaco asigarije Mimi Mireille/ Ivyo nkina Mimi ntavyo yokina... Arvella n'a Mimi nti",
    description:
  ...
  },
  {
    ...
    title:
      "#MUKAZA: Kigingi n'a Arvella murugendo gwo gufasha ba Ntahonikora/ guteramisha kumusi mukuru wama...",
    description:
      "ELIMI MEDIA: Urugendo rwo gufasha abatishoboye no gusabana n'abaturage.",
    duration: "11:52",
    views: "302 views",
  ...
  },
  {
    ...
    title:
      "MAREZO NA MAYERI NTACO BASIGIYE COSTANCE BAMUBAZA IMPAMVU AVYARA KUMWANYA KUMWANYA",
    description:
      "ELIMI MEDIA: Talk show nsekeje kandi ifite ubutumwa bukomeye ku mibanire n'umuryango.",
    duration: "14:20",
    views: "170 views",
    uploadedAt: "2 weeks ago",
    likes: 13,
  ...
  },
  {
    ...
    title:
      "Arvella Muhimbare niryambere ngiye Gukorera Imiriyoni ku kwezi/ Reco ihinduka ry'Isuku Mu Burundi",
    description:
      "ELIMI MEDIA: Iterambere ry'ubucuruzi n'isuku mu mujyi wa Bujumbura.",
    duration: "19:40",
    views: "156 views",
    uploadedAt: "2 weeks ago",
    likes: 6,
  ...
  },
  {
    ...
    title:
      "Twigeze gusaba I photo abaririmvyi bagenzi bacu/ Muri Gospel urukundo nogushigikirana birahari",
    description:
      "ELIMI MEDIA: Urukundo n'ubumwe mu baririmbyi ba Gospel mu Burundi.",
    duration: "24:10",
    views: "348 views",
  ...
  },
  {
    ...
    title:
      "Parcelle za 5M n'inzu zamahela make ibujumbura??😳 ikibazo Co kugura no kugurisha kiratorewe inyishu",
  ...
  },
  {
    ...
    title:
      "Turamenye CHEVAL iyo ageze nicatumye ahunga//Djicia yarasinye ko atazosubira😭",
  ...
  },
  {
    ...
    title:
      "Chris Easy wo mu🇧🇮/Mama Burundi yarampaye 10millions ndamuririmbiye 5min/ Karaoke sinzoyihemukira",
  ...
  },
  {
    ...
    description:
      "Exclusive coverage of the prestigious fashion show and traditional craft couture.",
    duration: "18:45",
    views: "3.4K views",
    uploadedAt: "1 month ago",
    likes: 620,
  },
  {
    ...
    description:
      "Behind the scenes with luxury VIP mobility, Mercedes V-Class motorcade and executive security.",
    duration: "15:20",
    views: "4.1K views",
    uploadedAt: "1 month ago",
    likes: 850,
  },
  {
    ...
    description:
      "Documentary exploring the heritage and master weavers of Gitega cultural centers.",
    duration: "22:10",
    views: "1.5K views",
  ...
  },
  {
    ...
    description:
      "Keynote speeches, venture showcases and business networking at the national convention.",
    duration: "31:40",
    views: "5.2K views",
    uploadedAt: "2 months ago",
    likes: 910,
  },
  {
    ...
    description:
      "Pro equipment tutorial featuring DJI 4K drone cinematography and live studio lighting.",
    duration: "27:15",
    views: "2.8K views",
    uploadedAt: "2 months ago",
    likes: 540,
  },
  {
    ...
    description:
      "Crime prevention documentary series produced by ELIMI Media studios.",
    duration: "34:50",
    views: "6.7K views",
    uploadedAt: "2 months ago",
    likes: 1250,
  },
  {
    ...
    description:
      "Captivating rhythmic performance celebrating national cultural identity and folklore.",
    duration: "14:35",
    views: "8.3K views",
  ...
  },
  {
    ...
    description:
      "Spotlight on fine Swiss craftsmanship and executive lifestyle accessories.",
    duration: "12:50",
    views: "1.9K views",
    uploadedAt: "3 months ago",
    likes: 410,
  },
  {
    ...
    description:
      "Tour of contemporary architectural villas and urban planning developments.",
    duration: "20:10",
    views: "3.1K views",
    uploadedAt: "3 months ago",
    likes: 670,
  },
  {
    ...
    description:
      "Studio session and sound design insights from award-winning music producers.",
    duration: "29:30",
    views: "2.5K views",
    uploadedAt: "3 months ago",
    likes: 530,
  },
  {
    ...
    description:
      "Spotlight on organic agricultural projects and modern irrigation technologies.",
    duration: "17:45",
    views: "1.4K views",
  ...
  },
  {
    ...
    description:
      "Laugh out loud moments and hilarious theatrical sketches recorded live.",
    duration: "23:15",
    views: "4.8K views",
    uploadedAt: "4 months ago",
    likes: 990,
  },
  {
    ...
    description:
      "Breathtaking landscapes, luxury yachting and travel guide across Lake Tanganyika.",
    duration: "16:20",
    views: "3.7K views",
    uploadedAt: "4 months ago",
    likes: 780,
  },
  {
    ...
    description:
      "Empowering next-gen innovators with high-impact software and electronics workshops.",
    duration: "19:00",
    views: "2.2K views",
  ...
  },
  {
    ...
    description:
      "Artisanal process of crafting Goodyear welted dress shoes and leather bags.",
    duration: "15:40",
    views: "2.6K views",
    uploadedAt: "5 months ago",
    likes: 580,
  },
  {
    ...
    description:
      "From farm to cup: Discovering single-origin specialty Arabica coffees of Burundi.",
    duration: "18:10",
    views: "3.9K views",
    uploadedAt: "5 months ago",
    likes: 820,
  },
  {
    ...
    description:
      "Red carpet arrivals, honorary speeches and awards celebrating visionary leaders.",
    duration: "35:00",
    views: "7.5K views",
    ...
    if (channelRes.ok) {
      ...
      if (match) {
        ...
        for (const l of lockups) {
          const videoId =
            l.contentImage?.thumbnailViewModel?.overlays?.[0]
          ...
          const duration =
            l.contentImage?.thumbnailViewModel?.overlays?.[0]
              ?.thumbnailBottomOverlayViewModel?.badges?.[0]
              ?.thumbnailBadgeViewModel?.text || "14:20";
          const metadataRows =
            l.metadata?.lockupMetadataViewModel?.metadata
          ...
          if (videoId && title) {
            ...
            const isShort =
              duration.includes("0:") &&
              parseInt(duration.split(":")[1] || "0", 10) <= 60;
    ...
    if (rssRes.ok) {
      ...
      while ((match = entryRegex.exec(xml)) !== null) {
        ...
        if (videoIdMatch && titleMatch) {
          ...
          const starCount = starRatingMatch
            ? parseInt(starRatingMatch[1], 10)
            : 0;
          const likesCount =
            starCount > 0
              ? starCount * 14
              : Math.max(18, Math.floor((viewsCount || 500) * 0.08));
          const commentsCount = Math.max(
            5,
            Math.floor((viewsCount || 500) * 0.035),
          );

          let viewsFormatted =
            viewsCount >= 1000
              ? `${(viewsCount / 1000).toFixed(1)}K views`
              : `${viewsCount} views`;
          ...
          videoMap.set(videoId, {
            ...
            description:
              ...
              `Watch "${title}" on ELIMI Media official channel.`,
            category,
            duration:
              existing?.duration ||
              (title.toLowerCase().includes("#shorts") ? "0:58" : "14:20"),
  ...
  for (const fallback of FALLBACK_ALL_VIDEOS) {
    if (fallback.youtubeId && !videoMap.has(fallback.youtubeId)) {
      ...
      videoMap.set(fallback.youtubeId, {
        ...
        description:
          fallback.description || `Watch "${fallback.title}" on ELIMI Media.`,
        category,
