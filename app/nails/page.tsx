...
export default function NailsPage() {
  ...
  const cartSubtotalBIF = cart.reduce(
    (sum, item) => sum + (item.priceBIF || item.price * 3000) * item.quantity,
    0,
  );
  ...
  const addToCart = (
    ...
    const price =
      "priceUSD" in product ? product.priceUSD : (product as any).price || 15;
    const priceBIF =
      "priceBIF" in product
        ? product.priceBIF
        : (product as any).priceBIF || price * 3000;
  ...
  const shopNailsProducts = useMemo(() => {
    ...
    if (selectedSubCat !== "All") {
      const subFiltered = nailItems.filter((p) => {
        if (selectedSubCat === "Gel Polish")
          return (
            p.subCategory?.includes("Gel") ||
            p.name.includes("Gel") ||
            p.name.includes("Polish")
          );
        if (selectedSubCat === "Nail Art Tools")
          return (
            p.subCategory?.includes("Tools") ||
            p.name.includes("Brush") ||
            p.name.includes("Drill")
          );
        if (selectedSubCat === "Nail Art Decor")
          return (
            p.subCategory?.includes("Decor") ||
            p.name.includes("Glitter") ||
            p.name.includes("Foil")
          );
        if (selectedSubCat === "Press On Nails")
          return (
            p.subCategory?.includes("Press-On") ||
            p.name.includes("Press On") ||
            p.name.includes("Kit")
          );
        if (selectedSubCat === "Nail Stickers")
          return (
            p.subCategory?.includes("Stickers") || p.name.includes("Sticker")
          );
        if (selectedSubCat === "Nail Kits")
          return (
            p.subCategory?.includes("Kit") ||
            p.name.includes("Kit") ||
            p.name.includes("Machine")
          );
        return true;
      });
  ...
  const categories = [
    {
      ...
      subCat: "Gel Polish",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuAxXHAMQ3aC8vEWVz-achmjxj9kTKZyZjTsiw4PYcSfpDw2CoMXkYQfulqBk6btIu4jqPNWBaxnDVo3Mg3qz1KN9uQx07LWsWroN6oQiGEjQ9Cu5NPvqnJNZ5ghuBwU3SaB_0eFPw1OZucYZh-WwX9a9IjugIsqlaqSjUtvLM_UsXBK38H5gI8MLFPOTKgDYeXWHwjrzREDM-H68Tnu_OWjMXnvGRUaypbSbKW1O4ypCWRNDfT8yEhSHw",
    },
    {
      title: "Nail Art Tools",
      subCat: "Nail Art Tools",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuBfiRnqRD73c8gbOPXaXoRXZyl_pYtNUXsWcu0ppxJzEy_i2KXdihwCzXR65o9QETynNzSeNDNyF35MdUwtSK4MsL63XZVwgQxVAWqQvlG2ZwQ2Cl_gN7pYyFi_FtTFgE_D1cdTF6T302nZhD7tOY-mmGSS_df8aGEgndVy6TaU9m6raErZCrWlnrp0eubteSbg6xftOvanK88Ajk5myvw1-66PgTXyKg_gqAIys1QfraFB7PWZIy5N4A",
    },
    {
      title: "Nail Art Decor",
      subCat: "Nail Art Decor",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuCMQvSDVEsvhXUhtUWiAgVZZVsu3IeW3KLkOodsWS2MyFR0YsJ7-_gROE_5R5_N9jaOIdpyoR-zVAs6E9OVNVXgQmEDWwl_9d4_2-pellANkZeAwMTZwQOYLLCPY5vuC32p2Hjt9L_hHRLU0lRB002KHb_9P_0tDBNyhw3_Im6erVL-zqC6xkZNSxkIkqkSK5dLkqHrJKBVZn848TOutiVgrzYv4YxulFQT1W6Wzv2cGKyEcXaD-c_A0g",
    },
    {
      title: "Press On Nails",
      subCat: "Press On Nails",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuAH3b8G5O824RZNCiUKQ6u_7fBwYLzYUVx-7mU-M_GrCof0w-T7xS5UKyAW-252yXJIseIkp6ZKle9yUDdMqkIYIwuLD7XTHUT0L8zHHFWMLEc3gpoVmTKgNgUmZwAb2RWGJGhRox2_Nt4BnVSsV3WTnXJwvGQC-3w1XtKCmEGcFhVuXQ5WWTYywFAAImktvKnFlkXEXczDnoT3UnYj8ApaNM57lDcuBGglD87VX-JVN-dWLwAxFh5euA",
    },
    {
      title: "Nail Stickers",
      subCat: "Nail Stickers",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuD_Wq-nO0r44aiZjw-vrkPC1QPBwz-JACfYO3wK6lPphjzG1AJ8SKpnYAbPswhc3AbKXA3phdxEfAK1ZYTsjpogUoEpBA50Sky7lBQTBhZYp0q5wMiLSEmNxk-zHsmnihWDpZrsTdBI8u2QAPyK3vKfw2MHcuYFCVq6x-OpsG5AdFduVrKW3KgUNg94QynnAW5tqhtLhkWj2gEDzhnAqBfy9mfdIcAd9wC_5sPqOYdDVLkrsckP1hhsIg",
    },
    {
      title: "Nail Kits",
      subCat: "Nail Kits",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuAoIX8qcLkt1DjkdkPsriFTS1I3pyI4QTH8iRNh31qvZ0ChsfjHteaMzHkyKMx5Wll6Hhj1fGsY6u1SyMvrRTBGkhCmn2Isn2RRUaZc5n9SrQRjxxp4ybvabveiavzFDZNdj_OTn5EC9S8KcSqUGEoUacOLDx8H8wQJsvVMKJ_J7NYElHOKJvOqUWUlg4z6ghvFe4moNGDZ3QQewQbhZhOpwVlw4a-Dh5o7_a_rYuYepiMau6_Gh--saw",
    },
  ];
  ...
  return (
    <div className="text-[#1e293b] antialiased min-h-screen bg-[#f8f9fc] font-sans flex flex-col">
            ...
            <div className="overflow-y-auto flex-1 divide-y divide-gray-100 pr-1">
              {searchedProducts.length === 0 ? (
                <div className="py-8 text-center text-sm text-gray-500">
                  No products matched &ldquo;{searchQuery}&rdquo; in our live
                  Firestore catalogue.
                </div>
              ) : (
                searchedProducts.map((p) => (
                  <div
                    key={p.id}
                    className="py-3 flex items-center justify-between gap-3 hover:bg-blue-50/50 p-2 rounded-xl transition"
                  >
              ...
              {cart.length === 0 ? (
                <div className="text-center py-12 text-gray-500">
                  ...
                  <p className="text-xs text-gray-500 mb-6">
                    Explore our live Firestore boutique catalogue and add your
                    favorites!
                  </p>
                  <button
                    onClick={() => setIsCartOpen(false)}
                ...
                <div className="space-y-3">
                  {cart.map((item) => (
                    <div
                      key={item.id}
                      className="flex gap-3 sm:gap-4 items-center bg-gray-50 p-3 rounded-xl border border-gray-100"
                    >
                      <img
                        src={item.image}
                        alt={item.name}
                      ...
                      <div className="flex-1 min-w-0">
                        <h4 className="font-semibold text-xs sm:text-sm truncate text-gray-900">
                          {item.name}
                        </h4>
            ...
            {cart.length > 0 && (
              <div className="pt-5 border-t border-gray-200 mt-6 bg-white">
                <div className="flex justify-between items-baseline mb-1">
                  <span className="text-xs sm:text-sm font-semibold uppercase text-gray-600">
                    Subtotal (USD)
                  </span>
                ...
                <div className="flex justify-between items-baseline mb-3 text-xs text-gray-500">
                  ...
                  <span className="font-semibold text-gray-700">
                    {cartSubtotalBIF.toLocaleString()} BIF
                  </span>
                </div>
                <p className="text-[11px] text-gray-400 mb-3">
                  Live Firestore synced inventory with instant WhatsApp order
                  dispatch.
                </p>
                <div className="space-y-2">
                    ...
                    href={`https://wa.me/25779000000?text=${encodeURIComponent(
                      `Hello ELIMI Nails & Boutique! I would like to place an order from your shop:\n\n` +
                        cart
                          .map(
                            (c) =>
                              `• ${c.name} (x${c.quantity}) - $${(c.price * c.quantity).toFixed(2)} / ${(c.priceBIF || c.price * 3000) * c.quantity} BIF`,
                          )
                          .join("\n") +
                  ...
                  <button
                    onClick={() => {
                      showToast(
                        "Order recorded successfully! We are preparing your shipment.",
                      );
                      setCart([]);
                      setIsCartOpen(false);
                    }}
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center pt-10 sm:pt-14 md:py-20 px-4 sm:px-6 md:px-8 lg:px-12 gap-8 md:gap-12">
          ...
          <div className="w-full md:w-1/2 z-10 text-center md:text-left">
            ...
            <p className="text-sm sm:text-base text-gray-600 mb-6 sm:mb-8 max-w-lg mx-auto md:mx-0 leading-relaxed">
              Discover salon-grade gel polishes, professional nail art tools,
              and bespoke press-on designs tailored for luxury and everyday
              elegance.
            </p>
      ...
      <main className="py-12 sm:py-16 md:py-20 flex-grow">
        ...
        <section
          id="categories"
          className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 mb-16 sm:mb-20 scroll-mt-24"
        >
          <div className="text-center max-w-2xl mx-auto mb-8 sm:mb-12">
            ...
            <p className="text-xs sm:text-sm text-gray-500 mt-2">
              Browse real-time salon supplies, press-ons, and tools synced
              directly from our Firestore database.
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row md:justify-between md:items-end mb-6 sm:mb-8 gap-4">
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-500 mt-1">
                Real-time boutique inventory with instant ordering and live
                USD/BIF conversion.
              </p>
            </div>
          ...
          {isLoadingFirestore ? (
            ...
            <div className="bg-white border border-dashed border-gray-300 rounded-2xl p-10 text-center">
              ...
              <p className="text-xs text-gray-500 mb-4">
                Try clearing the category filter or searching for another nail
                product.
              </p>
              <button
          ...
          <div className="bg-gradient-to-br from-[#EBF3FF] via-[#F4F8FF] to-white rounded-3xl overflow-hidden flex flex-col md:flex-row shadow-sm border border-blue-200/80">
            ...
            <div className="p-6 sm:p-10 md:p-12 lg:p-14 flex-1 flex flex-col justify-center border-b md:border-b-0 md:border-r border-blue-100">
              ...
              <p className="mb-6 sm:mb-8 text-gray-600 text-xs sm:text-sm md:text-base leading-relaxed">
                Everything you need for stunning nails — non-toxic formulations,
                ultra-pigmented shades, and salon-certified tools.
              </p>
              <div>
                <a
                  href="#best-sellers"
        ...
        <section
          id="inspired"
          className="mb-8 scroll-mt-24 max-w-7xl mx-auto px-4 sm:px-6 md:px-8"
        >
      ...
      <footer className="bg-[#0f172a] text-gray-300 pt-12 sm:pt-16 pb-8 border-t border-gray-800 mt-auto">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12 mb-10">
          ...
          <div className="space-y-4">
            <Link
              href="/"
              className="font-serif text-2xl font-bold tracking-tight text-white flex items-center gap-2"
            >
              <span>ELIMI</span>
            ...
            <p className="text-xs sm:text-sm text-gray-400 leading-relaxed">
              Curated salon nail art, gel finishes, and precision tools for
              creators and professionals in Burundi.
            </p>
          ...
          {/* Links Column 1 */}
          <div>
            <h4 className="font-bold uppercase tracking-wider mb-3 text-xs sm:text-sm text-white">
              Shop Categories
            </h4>
            <ul className="space-y-2 text-xs sm:text-sm text-gray-400">
              <li>
                <Link href="/nails" className="hover:text-blue-400 transition">
                  Studio Home
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs sm:text-sm text-gray-400">
              ...
              <li>
                <Link href="/houses" className="hover:text-blue-400 transition">
                  Estates &amp; Residencies
                </Link>
              </li>
              <li>
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-xs sm:text-sm text-gray-400 mb-3">
              Sign up for special drops and 10% off your first order.
            </p>
            ...
            {newsletterSuccess ? (
              ...
              <form
                ...
                className="flex border border-gray-700 rounded-xl p-1 bg-slate-900 focus-within:border-[#0D52FF]"
              >
                <input
                  type="email"
                  required
